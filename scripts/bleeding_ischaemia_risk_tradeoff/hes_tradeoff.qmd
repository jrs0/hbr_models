...
# Note the trailing semicolon to surpress printed output
data_ds = ds.Dataset(
...
feature_groups = data_ds.feature_groups()
num_features = 3
...
The dataset contains `{python} num_features`
...
for m, (model, model_title) in enumerate(model_names.items()):
  ...
  plot_risk_tradeoff(dataset, model, bleeding_outcome, ischaemia_outcome)
