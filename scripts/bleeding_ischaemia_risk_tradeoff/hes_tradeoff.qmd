...
for m, (model, model_title) in enumerate(model_names.items()):
  ...
  bleeding_summary = model_summary[model_summary["Outcome"] == outcome_names[bleeding_outcome].title()]
  ischaemia_summary = model_summary[model_summary["Outcome"] == outcome_names[ischaemia_outcome].title()]
